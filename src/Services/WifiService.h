...
public:
    ...
    const uint8_t* getWifi5ghzChannels() const;
    ...
    inline static const uint8_t wifi5ghzChannels[] = {
        36, 40, 44, 48, 52, 56, 60, 64,
        100, 104, 108, 112, 116, 120, 124, 128, 132, 136, 140, 144,
        149, 153, 157, 161, 165
    };

    inline static const size_t wifi5ghzChannelsCount = sizeof(wifi5ghzChannels) / sizeof(wifi5ghzChannels[0]);
};