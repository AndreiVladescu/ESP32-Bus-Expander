...
const uint8_t* WifiService::getWifi5ghzChannels() const {
    return wifi5ghzChannels;
}

size_t WifiService::getWifi5ghzChannelsCount() const {
    return wifi5ghzChannelsCount;
}
